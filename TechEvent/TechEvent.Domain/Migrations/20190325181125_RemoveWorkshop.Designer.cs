...
namespace TechEvent.Domain.Migrations
{
    ...
    [Migration("20190325181125_RemoveWorkshop")]
    partial class RemoveWorkshop
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TechEvent.Domain.Entities.Room", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("TechEvent.Domain.Entities.Schedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<int?>("BreakAfter");
            ...
            modelBuilder.Entity("TechEvent.Domain.Entities.Paper", b =>
                {
                    ...
                    b.HasOne("TechEvent.Domain.Entities.PaperStatus", "PaperStatus")
                        .WithMany("Papers")
                        .HasForeignKey("PaperStatusId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("TechEvent.Domain.Entities.Schedule", b =>
                {
                    ...
                    b.HasOne("TechEvent.Domain.Entities.Room", "Room")
                        .WithMany("Schedules")
                        .HasForeignKey("RoomId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("TechEvent.Domain.Entities.Talk", "Talk")
                        .WithOne("Schedule")
                        .HasForeignKey("TechEvent.Domain.Entities.Schedule", "TalkId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
